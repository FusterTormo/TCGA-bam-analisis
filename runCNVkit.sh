...
#TODO pendiente ver que funcion de CNVkit usar para poder leer los datos en Alfre2
#Convertir los datos en un grafico de puntos -> cnvkit.py scatter archivo.cnr -s archivo.cns [ -o dibujo.pdf ]
GREEN='\033[0;32m'
RED='\033[0;31m'
NC='\033[0m' # No Color
...
then
	...
	then
		...
		$HOME/Scripts/repository/createCNVkitPoolReference.sh
	fi
	if [ ! -f $flat ]
	then
		echo -e "\n${RED}Flat reference not found.${NC}\n Compiling a new one.\n"
		$HOME/Scripts/repository/createCNVkitFlatReference.sh
	fi
