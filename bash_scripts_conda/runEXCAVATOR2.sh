...
## Change path depending on excavator according to user launching the script, otherwise w permissions exception arises
# path_excavator2='/home/ffuster/soft/'
## Jose installed excavator under the path of the conda environment (not really in the conda environment!!!)
path_excavator2='/home/jespinosa/conda_local_env/excavator2/'
...
then
	...
	then
		...
		## Jose activate environment containing ggplot2, since the second node has been added to the cluster
        ## given the problems of synchronizing the server there are not R libraries installed for all users
		conda activate '/home/jespinosa/conda_local_env/excavator2'
		sta=`date`
		SECONDS=0		
		
		## pathEX=~/soft/EXCAVATOR2_Package_v1.1.2
		pathEX=${path_excavator2}EXCAVATOR2_Package_v1.1.2
